...
class UserController extends Controller
{
    ...
    {
        // Ejecutar validaciones de la peticion
        ...
        //Redireccionar con un mensaje en especial
        if ($request->name == 'luis') {
            return Redirect()->route('users.create')->withErrors(["Nombre" => "No se Puede Registrar un luis"]);
        }
        /*
        //Primera Forma
        ...
        */
        ...
        // Mensaje Flash (una vez usasda se elimina la variable)
        $request->session()->flash('message', 'Usuario creado!');
        return FacadesRedirect::to('users');
    }
